...
import android.widget.Button;  
 ...
 public class TakePictures  extends Activity{  
    ...
    private void takePic() {  
       ...
       Log.v("demoAPK","Befor takingpicture!");
        camera.takePicture(null, null, pictureCallback); // picture  
        Log.v("demoAPK","After takingpicture!");
        if(picture != null)
        {
        Log.v("demoAPK","picture is not null!");
        Bundle bundle = new Bundle();      
        bundle.putString("pictureaddr", picture.getPath());
        Intent intent = new Intent(TakePictures.this, Setoutdate.class);
        ...
        {
        Log.v("demoAPK","picture is  null!");
        Bundle bundle = new Bundle();      
        bundle.putString("pictureaddr","");
        Intent intent = new Intent(TakePictures.this, Setoutdate.class);
        intent.putExtras(bundle);
        Log.v("demoAPK","before startactivity!");
        startActivity(intent);
    ...
    class SavePictureTask extends AsyncTask<byte[], String, String> {  
        ...
        protected String doInBackground(byte[]... params) {  
            ...
            Log.i(TAG, "fname="+fname+";dir=/data/data/");  
            ...
            // picture=new File("/data/data/"+fname) ;
             picture=new File(getApplicationContext().getFilesDir().getAbsolutePath()+"/"+fname);
            try {  
